...
function user_login() {
    ...
    if(email == "") {
       ...
       jQuery("#login_password_error").html("Plese Enter password");
       var is_error = 'yes';
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                if(result == 'wrong') {
                    $(".login_message").html("Please enter valid login info");
...
function manage_cart(pid, type) {
    ...
    if(qty > 0) {
        ...
        jQuery('.zero_qty_message').remove();
    }else {
